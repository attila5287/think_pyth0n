...
def main():
    ...
    for label in PokerHand.all_labels:
        ...
        label4plot_list.append(str(label))
        probs4plot_list.append(int(p.__round__(0)))
        reciprocal_prop = p.__round__(4)
        reciprocal_prop = reciprocal_prop**-1
        probFix_list.append(reciprocal_prop.__round__(4))


    print(label4plot_list)
    print(probs4plot_list)
    print(probFix_list)
    for label, prob in zip(label4plot_list, probFix_list):
        plt.bar(label, prob)
